...
OnLead.TOOLS = [
  ...
  },
  {
    ...
    fields: [
      { key: "sources", label: "Источники (ссылки сообществ)", type: "textarea", placeholder: "https://vk.com/public… — по одной на строку" },
      { key: "keys", label: "Ключи включения", type: "text", placeholder: "акция, скидка, новость" },
      { key: "dest", label: "Куда публиковать", type: "select", options: ["Личная стена", "Сообщество 1", "Очередь автопостинга"], value: "Очередь автопостинга" },
      { key: "replaceUrl", label: "Замена ссылок", type: "text", placeholder: "https://ваш-сайт.ru" },
      { key: "perDay", label: "Постов в сутки", type: "number", value: "10", min: 1, max: 50 },
    ],
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "list", label: "Кого приглашать", type: "select", options: ["Свой список", "Друзья друзей", "Парсинг группы"], value: "Свой список" },
      { key: "listId", label: "Список получателей", type: "lists" },
      { key: "sourceGroup", label: "Группа-источник (для парсинга)", type: "text", placeholder: "https://vk.com/public…" },
      { key: "perDay", label: "Приглашений в день", type: "number", placeholder: "30", value: "30", min: 1, max: 50 },
  ...
  },
  {
    ...
    fields: [
      { key: "scope", label: "Где чистить", type: "select", options: ["Друзья", "Подписчики", "Участники группы"], value: "Друзья" },
      { key: "rules", label: "Правила удаления", type: "select", options: ["Боты", "Нет фото", "Не заходили 365 дней", "Все эвристики"], value: "Все эвристики" },
      { key: "perDay", label: "Удалений в сутки", type: "number", value: "20", min: 1, max: 100 },
      { key: "whitelist", label: "Белый список (не трогать)", type: "lists" },
    ],
  ...
  },
  {
    ...
    fields: [
      { key: "chats", label: "Ссылки на беседы", type: "textarea", placeholder: "https://vk.com/im?sel=c…" },
      { key: "welcome", label: "Приветствие новичкам", type: "textarea", placeholder: "{name}, добро пожаловать!", value: "{name}, добро пожаловать в чат!" },
      { key: "rules", label: "Автомодерация", type: "select", options: ["Выкл", "Ссылки", "Спам-слова", "Строгая"], value: "Ссылки" },
      { key: "kick", label: "Кик нарушителей", type: "select", options: ["Выкл", "После спама"], value: "Выкл" },
      { key: "perDay", label: "Автоответов в сутки", type: "number", value: "50", min: 1, max: 200 },
    ],
  ...
  },
  {
    ...
    fields: [
      { key: "groups", label: "Сообщества", type: "textarea", placeholder: "https://vk.com/club… — по одной на строку" },
      { key: "autoJoin", label: "Заявки на вступление", type: "select", options: ["Вручную", "Авто-одобрение", "По списку"], value: "Вручную" },
      { key: "list", label: "Белый список (для «По списку»)", type: "lists" },
      { key: "blacklist", label: "Чёрный список", type: "lists" },
      { key: "groupAccess", label: "Статус группы", type: "select", options: ["Не менять", "Открытая", "Закрытая", "Приватная"], value: "Не менять" },
      { key: "editors", label: "Редакторы / модераторы", type: "textarea", placeholder: "https://vk.com/id123 — редактор" },
    ],
